        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          <div className="flex flex-wrap p-5 border border-[#E5E7EB] rounded-xl">
            ...
            <div className="flex flex-col">
              <h6 className="text-base text-primary-normal font-medium">
                Total Views
              </h6>
        ...
        <div className="grid grid-cols-6 gap-4">
          <div className="col-start-1 col-end-7 xl:col-start-1 xl:col-end-5">
            <div className="inline-block w-full p-3 border border-[#E5E7EB] rounded-md h-[208px] mb-3">
              <div className="flex items-center">
                ...
                <h6 className="text-primary-main font-bold text-sm">
                  Total Views
                </h6>
              </div>
          ...
          <div className="col-start-1 col-end-7 xl:col-start-5 xl:col-end-7">
            <div className="inline-block w-full p-4 border border-[#E5E7EB] rounded-md">
              ...
              <p className="text-sm text-primary-light font-normal mb-4">
              ...
              <div className="inline-block w-full">
                <div
                  tabIndex={0}
                  className="collapse bg-transparent rounded-box mb-2"
                >
                  <input type="checkbox" />
                  ...
                  <div className="flex items-center justify-between collapse-title p-0">
                    <div className="flex">
                      ...
                      <div className="flex flex-col">
                        <h4 className="text-primary-main text-base font-semibold">
                          Popup Usecase
                        </h4>
                        <p className="text-primary-normal text-xs">
                          Discover how you should use PopMe
                        </p>
                      </div>
                    </div>
