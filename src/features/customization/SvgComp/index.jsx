...
export const CloseCircle = () => (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className="w-6 h-6 text-secondary-main"
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const VolumeSvg = ({ color = "#fff" }) => (
  <>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export const MuteSvg = ({ color = "#fff" }) => (
  <>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
...
export const DashSvg = ({ color = "#fff" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const PauseSvg = ({ color = "#fff" }) => (
  <>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24px"
