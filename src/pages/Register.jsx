  ...
  return (
    <div className="min-h-screen flex items-center">
      <div className='mx-auto w-full max-w-xl'>
        ...
        <h2 className='text-3xl font-bold mb-2 text-center text-primary-main'>Signup to create an account</h2>
        <h6 className="text-center text-base font-normal text-secondary-main mb-8"><span className="text-[#4B5563]">Already have an account?</span> Login</h6>
          ...
          <div className="flex mb-3">
            <div className="form-control">
              <label className="label cursor-pointer">
                <input type="checkbox" className="checkbox checkbox-sm checkbox-borderColor-main rounded-md mr-2" />
                <h6 className="text-base font-normal text-primary-main">I agree to the <span className="text-secondary-main">Terms of Use</span> and <span className="text-secondary-main">Privacy Policy</span></h6>
              </label>
            </div>
          </div>
