                            ...
                            <div className='inline-block w-full bg-[#E5E7EB] border border-borderColor-main rounded-xl'>
                                <div className='flex flex-col'>
                                    ...
                                    <div className='flex p-4'>
                                        <img src={item.img} alt={item.name} className="h-[340px] w-full object-cover" />
                                    </div>

                                    <div className="inline-block w-full p-4 bg-white rounded-xl mt-2">
                                        <div className='flex justify-between items-center mb-5'>
                                            <div className='flex flex-col'>
                                                <h4 className=" text-primary-normal text-lg font-bold">{item.name}</h4>
                                                <p className="text-primary-normal text-sm">{item.description}</p>
                                            </div>
                                        ...
                                        <div className='flex mb-5'>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <h4 className="text-primary-main text-base font-bold">{item.totalViews}</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex mb-5'>
                                            ...
                                            <div className='flex flex-col'>
                                                <p className="text-primary-normal text-sm">Total Minutes Watchtime</p>
                                                <h4 className="text-primary-main text-base font-bold">{item.totalMinWatch}</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div className='flex'>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <h4 className="text-primary-main text-base font-bold">{item.totalClickedCTA}</h4>
                                            </div>
                                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className='inline-block w-full p-4'>
                                <div className='flex flex-col justify-center items-center border-4 border-dashed border-borderColor-main h-[340px]'>
                                    {PlusIcon()}
                                    <h3 className='text-lg text-primary-normal'><span className="text-secondary-main">Create</span> a new Workspace</h3>
                                </div>
                            </div>
                            ...
                            <div className="inline-block w-full p-4 bg-white rounded-xl mt-2">
                                <div className='flex justify-between items-center'>
                                    <div className='flex flex-col'>
                                        <h4 className=" text-primary-normal text-lg font-bold">{`Workspace #${Data.length + 1}`}</h4>
                                        <p className="text-primary-normal text-sm">Create a new Workspace</p>
                                    </div>
